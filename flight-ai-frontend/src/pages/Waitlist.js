...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .logo { display: flex; align-items: center; gap: 10px; margin-bottom: 40px; animation: fadeUp 0.6s ease both; }
  ...
  .launch-badge { display: inline-flex; align-items: center; gap: 8px; background: rgba(99,102,241,0.1); border: 1px solid rgba(129,140,248,0.25); color: #a5b4fc; padding: 8px 18px; border-radius: 20px; font-size: 12px; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 24px; animation: fadeUp 0.6s ease 0.1s both; }
  .badge-dot { width: 6px; height: 6px; background: #6ee7b7; border-radius: 50%; animation: blink 2s ease infinite; }
  @keyframes blink { 0%,100%{opacity:1;}50%{opacity:0.3;} }

  .hero-title { font-family: 'Orbitron', sans-serif; font-size: clamp(28px, 6vw, 56px); font-weight: 800; line-height: 1.1; background: linear-gradient(135deg, #e0e7ff 0%, #a5b4fc 40%, #c084fc 70%, #38bdf8 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin-bottom: 16px; letter-spacing: 1px; animation: fadeUp 0.6s ease 0.2s both; }
  .hero-sub { font-size: clamp(14px, 2.5vw, 17px); color: rgba(180,190,255,0.55); font-weight: 300; max-width: 500px; line-height: 1.7; margin-bottom: 32px; animation: fadeUp 0.6s ease 0.3s both; }

  .counter-wrap { display: flex; align-items: center; gap: 8px; justify-content: center; margin-bottom: 32px; animation: fadeUp 0.6s ease 0.35s both; }
  ...
  /* FORM */
  .waitlist-form { width: 100%; max-width: 500px; animation: fadeUp 0.6s ease 0.4s both; }
  ...
  .success-hero { background: rgba(52,211,153,0.08); border: 1px solid rgba(52,211,153,0.2); border-radius: 16px; padding: 24px; margin-bottom: 20px; }
  .success-icon { font-size: 40px; margin-bottom: 10px; }
  .success-title { font-family: 'Orbitron', sans-serif; font-size: 18px; font-weight: 700; color: #6ee7b7; margin-bottom: 6px; }
  .success-sub { font-size: 13px; color: rgba(110,231,183,0.6); }

  /* REFERRAL CARD */
  .referral-card { background: rgba(99,102,241,0.08); border: 1px solid rgba(129,140,248,0.2); border-radius: 16px; padding: 24px; margin-bottom: 20px; }
  .referral-title { font-family: 'Orbitron', sans-serif; font-size: 13px; font-weight: 600; color: #a5b4fc; letter-spacing: 1px; margin-bottom: 6px; }
  ...
  .reward-amount { font-family: 'Orbitron', sans-serif; font-size: 18px; font-weight: 800; color: #6ee7b7; }
  .reward-label { font-size: 11px; color: rgba(165,180,252,0.4); margin-top: 4px; }
  .ref-link-wrap { display: flex; gap: 8px; background: rgba(255,255,255,0.04); border: 1px solid rgba(129,140,248,0.2); border-radius: 10px; padding: 10px 14px; margin-bottom: 12px; }
  .ref-link-text { flex: 1; font-size: 12px; color: #a5b4fc; font-family: monospace; text-align: left; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  ...
  /* SHARE BUTTONS */
  .share-title { font-size: 12px; color: rgba(165,180,252,0.3); letter-spacing: 1px; text-transform: uppercase; margin-bottom: 10px; }
  .share-btns { display: flex; gap: 8px; justify-content: center; flex-wrap: wrap; }
  .btn-share { display: flex; align-items: center; gap: 6px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); color: rgba(165,180,252,0.6); padding: 10px 16px; border-radius: 10px; font-family: 'DM Sans', sans-serif; font-size: 13px; cursor: pointer; transition: all 0.2s; }
  .btn-share:hover { background: rgba(255,255,255,0.08); color: #a5b4fc; border-color: rgba(129,140,248,0.2); }

  /* LEADERBOARD */
  .leaderboard { width: 100%; max-width: 500px; margin-top: 32px; animation: fadeUp 0.6s ease 0.5s both; }
  .lb-title { font-family: 'Orbitron', sans-serif; font-size: 12px; font-weight: 600; color: rgba(165,180,252,0.4); letter-spacing: 2px; text-transform: uppercase; margin-bottom: 12px; }
  .lb-card { background: rgba(15,17,26,0.6); border: 1px solid rgba(255,255,255,0.06); border-radius: 14px; overflow: hidden; }
  .lb-row { display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-bottom: 1px solid rgba(255,255,255,0.04); transition: all 0.2s; }
  .lb-row:last-child { border-bottom: none; }
  .lb-row:hover { background: rgba(99,102,241,0.05); }
  .lb-rank { font-family: 'Orbitron', sans-serif; font-size: 12px; font-weight: 700; color: rgba(165,180,252,0.3); width: 24px; }
  .lb-rank.gold { color: #fbbf24; }
  .lb-rank.silver { color: #94a3b8; }
  .lb-rank.bronze { color: #b45309; }
  .lb-email { flex: 1; font-size: 13px; color: #94a3b8; text-align: left; }
  .lb-count { font-family: 'Orbitron', sans-serif; font-size: 13px; font-weight: 700; color: #6366f1; }
  .lb-label { font-size: 10px; color: rgba(165,180,252,0.3); margin-left: 2px; }

  /* FEATURES */
  .features { display: flex; gap: 20px; justify-content: center; flex-wrap: wrap; margin-top: 32px; animation: fadeUp 0.6s ease 0.6s both; }
  .feature { display: flex; align-items: center; gap: 8px; font-size: 13px; color: rgba(165,180,252,0.4); }

  .footer { margin-top: 48px; font-size: 12px; color: rgba(165,180,252,0.2); animation: fadeUp 0.6s ease 0.7s both; }
...
function Waitlist() {
  ...
  useEffect(() => {
    ...
    if (savedEmail && savedCode) {
      setMyData({ email: savedEmail, refCode: savedCode });
      setStatus("success");
      // fetch my referral count
  ...
  const shareWhatsApp = () => {
    const msg = encodeURIComponent(`🚀 I just joined the CometAI waitlist! Book flights using AI or WhatsApp — zero booking fees. Join using my link and we both get launch bonuses!\n\n${refLink}`);
    window.open(`https://wa.me/?text=${msg}`, "_blank");
  };

  const shareTwitter = () => {
    const msg = encodeURIComponent(`🚀 Just joined @CometAI waitlist — India's AI-powered flight booking with WhatsApp support is coming! Join using my link:\n\n${refLink}`);
    ...
    <>
      ...
      <div className="page">
        ...
        <p className="hero-sub">
          Book flights using AI or WhatsApp. Zero booking fees. India's smartest travel platform is almost here — join the waitlist and refer friends to unlock launch bonuses!
        </p>
        ...
        {status !== "success" ? (
          ...
          <div className="success-section">
            <div className="success-hero">
              ...
              <div className="success-sub">We'll notify you the moment CometAI launches. Now refer friends to unlock bonuses!</div>
            </div>
            ...
            <div className="referral-card">
              ...
              <div className="referral-desc">
                For every friend who joins using your link — you both get launch bonuses when they book their first flight above ₹5,000!
              </div>

              <div className="referral-reward">
                <div className="reward-item">
                  <div className="reward-amount">₹150</div>
                  <div className="reward-label">You get (per referral)</div>
                </div>
                <div className="reward-item">
              ...
              <div className="share-title">Share your link</div>
              <div className="share-btns">
                <button className="btn-share" onClick={shareWhatsApp}>📱 WhatsApp</button>
                <button className="btn-share" onClick={shareTwitter}>🐦 Twitter</button>
                <button className="btn-share" onClick={handleCopy}>{copied ? "✓ Copied!" : "🔗 Copy link"}</button>
              </div>
            </div>
          </div>
        )}
            ...
            <div className="lb-card">
              {leaderboard.slice(0,5).map((item, i) => (
                <div className="lb-row" key={i}>
                  ...
                  <div className="lb-count">{item.ref_count}<span className="lb-label"> refs</span></div>
                </div>
              ))}
            </div>
          </div>
